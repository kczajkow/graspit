...
//
// $Id: dof.h,v 1.13.2.2 2009/04/27 14:33:09 cmatei Exp $
//
//######################################################################
...
public:
  ...
  /*! Reads in the force parameters from a stream */
  virtual bool readParametersFromStream(QTextStream &stream);
...
public:
	...
	virtual bool readFromStream(QTextStream &stream);  
	//! Also reads in the break away torque level
	virtual bool readParametersFromStream(QTextStream &stream);
};
