...
//
// $Id: onLinePlanner.h,v 1.21.2.2 2009/04/27 14:33:11 cmatei Exp $
//
//######################################################################
...
/*	An online planner has the following characteristics:
	...
	fctn). Then, as the variables in the SearchState will define 
...
private:
	...
	double stateDistance(const SearchState *s1, const SearchState *s2);
