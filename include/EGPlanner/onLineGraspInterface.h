...
//
// $Id: onLineGraspInterface.h,v 1.3.2.2 2009/04/27 14:33:11 cmatei Exp $
//
//######################################################################
...
private:
	...
	bool getSuggestedDOF(const SearchState *s, double *initialDof, double *finalDof);
public:
	OnLineGraspInterface(Hand *h);
	SearchState* updateHand(const std::list<SearchState*> *solutionList);
