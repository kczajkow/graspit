...
//
// $Id: simAnn.h,v 1.22.2.2 2009/04/27 14:33:11 cmatei Exp $
//
//######################################################################
...
/*!	This class performs simulated annealing on a collection of variables 
	(a SearchState*). It has no idea of grasps, hands, etc. The cooling 
...
private:
	...
	//! Computes a neighbor of a given SearchState
	SearchState* stateNeighbor(SearchState *s, double T, SearchState *t = NULL);
...
public:
	...
	Result iterate(SearchState *currentState, SearchEnergy *energyCalculator, SearchState *targetState = NULL);
