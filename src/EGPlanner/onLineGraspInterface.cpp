...
//
// $Id: onLineGraspInterface.cpp,v 1.7.2.2 2009/04/27 14:33:15 cmatei Exp $
//
//######################################################################
...
*/
bool
OnLineGraspInterface::getSuggestedDOF(const SearchState *s, double *initialDof, double *finalDof)
{
...
*/
SearchState*
OnLineGraspInterface::updateHand(const std::list<SearchState*> *solutionList)
{
	...
	SearchState *s = NULL;
	std::list<SearchState*>::const_iterator it = solutionList->begin();
