...
//
// $Id: graspTesterThread.cpp,v 1.14.2.1 2009/04/24 22:19:22 cmatei Exp $
//
//######################################################################
...
void
GraspTester::postSolution(SearchState *s)
{
	mListMutex.lock();
...
bool
GraspTester::postCandidate(SearchState *s)
{
	mListMutex.lock();
...
void
GraspTester::testGrasp(SearchState *s)
{
