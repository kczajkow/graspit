...
//
// $Id: compliantPlannerDlg.h,v 1.7.2.2 2009/04/27 14:33:17 cmatei Exp $
//
//######################################################################
...
private:
	...
	void gridEllipsoidSampling(const SearchState &seed,
						       std::list<SearchState*> *sampling, int samples);
	//! Helper function for the above
	void addCartesianSamples(const SearchState &seed, std::list<SearchState*> *sampling, 
